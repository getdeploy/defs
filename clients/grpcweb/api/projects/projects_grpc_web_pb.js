 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.api.projects.AddAccountRequest,
 *   !proto.api.projects.AddAccountResponse>}
 */
const methodDescriptor_Projects_AddAccount = new grpc.web.MethodDescriptor(
  '/api.projects.Projects/AddAccount',
  grpc.web.MethodType.UNARY,
  proto.api.projects.AddAccountRequest,
  proto.api.projects.AddAccountResponse,
  /**
   * @param {!proto.api.projects.AddAccountRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.api.projects.AddAccountResponse.deserializeBinary
);
 ...
 *   !proto.api.projects.AddAccountResponse>}
 */
const methodInfo_Projects_AddAccount = new grpc.web.AbstractClientBase.MethodInfo(
  proto.api.projects.AddAccountResponse,
  /**
   * @param {!proto.api.projects.AddAccountRequest} request
   * @return {!Uint8Array}
...
/**
 * @param {!proto.api.projects.AddAccountRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.Error, ?proto.api.projects.AddAccountResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.api.projects.AddAccountResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.api.projects.ProjectsClient.prototype.addAccount =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/api.projects.Projects/AddAccount',
      request,
      metadata || {},
      methodDescriptor_Projects_AddAccount,
      callback);
};
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.api.projects.AddAccountResponse>}
 *     A native promise that resolves to the response
 */
proto.api.projects.ProjectsPromiseClient.prototype.addAccount =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/api.projects.Projects/AddAccount',
      request,
